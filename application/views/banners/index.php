...
<head>
    ...
    @media (min-width:1010px) and (max-width:1114px) {
        .active_btn {
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href=" <?php echo base_url('Banners'); ?>" class="nav-link active">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Banners
                                </p>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6" style="padding-left: 1%;padding-bottom: 1%;">
                            <h1>My Banners</h1>
                            <?php if($this->session->flashdata('add_banner_success')){ ?>
                            <div class='bg-success'>
                                <?php echo $this->session->flashdata('add_banner_success') ?>
                            </div>
                            <?php   } ?>
                            ...
                            <?php   } ?>
                            <?php if($this->session->flashdata('edit_banner_success')){ ?>
                            <div class='bg-success'>
                                <?php echo $this->session->flashdata('edit_banner_success') ?>
                            </div>
                            <?php   } ?>
                        </div>
                        <div class="col-sm-6 text_end" style="padding-right: 1%;">
                            <a href="<?php echo base_url('Banners/createBanner') ?>">
                        ...
                        ?>
                                            <tr>
                                                ...
                                                <td style="width:40%;">
                                                    ...
                                                    <div>
                                                        <img src=" <?php echo $CI->config->base_url().'/images/banner_images/'.$banner->banner_image  ?> "
                                                            alt="My member" class="banner_image">
                                                    </div>

                                                    <?php } ?>
                                                </td>
                                                <td> <?php echo $banner->status == 1 ? '<div class="row" style="height: 100%;">
                                                    <div class="col-12 col-md-7 col-lg-3 status"><i class="fa fa-check" style="    color: #17a2b8;"></i></div>
                                                    <div class="col-12 col-sm-12  col-lg-7 status"><button type="button" class="btn btn-info btn-block btn-flat active_btn">Active</button></div>
                                                </div>':'<div class="row" style="height: 100%;">
                                                <div class="col-12 col-md-7 col-lg-3 status"><i class="fa fa-times" style="    color: #dc3545;"></i></div>
                                                <div class="col-12 col-sm-12  col-lg-7 status"><button type="button" class="btn btn-danger btn-block btn-flat active_btn">Inactive</button></div>
                                                </div>'; ?>
                                                </td>
                                                <td class="action_colmn">
                                                    <span class="fa_view" style="margin: 2%;">
                                                        <a style="color:#000 !important"
                                                            href="<?php echo base_url('Banners/viewBanner/'.$banner->banner_id ) ?>"><span
                                                                class='fas fa-eye'></span></a></span>
                                                    <span class="fa_edit" style="margin: 2%;">
                                                        <a style="color:#000 !important"
                                                            href="<?php echo base_url('Banners/updateBanner/'.$banner->banner_id ) ?>"><span
                                                                class='fas fa-edit'></span></a></span>
                                                    <span class="fa_delete" style="margin: 2%;">
                                                        <span style="cursor:pointer;" data-bs-toggle="modal"
                                                            data-bs-target="#delete_banner"
                                                            onclick="deleteBannerid('<?php echo $banner->banner_id  ?>')">
        ...
        <div class="modal" id="delete_banner">
            <div class="modal-dialog">
                <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title text-center"> Delete Banner </h4>
                    ...
                    <input type="hidden" id="spin_id" name="spin_id">
                            ...
                            <div class="row pad-top">
                                ...
                                <div class="col-lg-6 text-center ">
                                    <form method="post" action="<?php echo base_url('Banners/deleteBanner') ?>">
    ...
    <!-- jQuery -->
    <script>
    function deleteBannerid(banner_id) {
        document.getElementById('delete_id').value = banner_id;
    }
    </script>

                    ...
                    <div class="row mb-2">
                        <div class="row category_head">
                            <div class="col-sm-6 col-lg-6 col-md-6 category_head_left">
                                <h1>Edit Contest Category List</h1>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="card-body">
                                                        <?php if($this->session->flashdata('edit_contest_category_error')){ ?>
                                                        <div class='alert alert-danger' role="alert">
                                                            <?php echo $this->session->flashdata('edit_contest_category_error') ?>
                                                        </div>
                                                        <?php   } ?>

                                                        <div class="form-group">
                                                            <?php foreach($category_info_by_id as $category_info){ ?>
                                                            <div class="form-group">
                                                                <label class="col-form-label">
                                                                    Contest Category Name</label>
                                                                <input type="text" name="category_contest_name"
                                                                    class="form-control"
                                                                    value="<?php echo $category_info->contest_category_name?>"
                                                                    placeholder="Please enter contest category name">
                                                                <input type="hidden" name="contest_category_id"
                                                                    value="<?php echo $category_info->contest_category_id ?>">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name='spin_id' class="custom-select">
                                                                    ...
                                                                    <?php  foreach($spin_info as $spin_name){ ?>
                                                                    <option value="<?php echo $spin_name->spin_id; ?>"
                                                                        <?php if($category_info->spin_id==$spin_name->spin_id) echo 'selected="selected"'; ?>>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="status_value" class="custom-select">
                                                                    ...
                                                                    <option value="1">Active
                                                                        ...
                                                                        <?php if($category_info->contest_category_status == 1) 'selected: selected' ?>>
                                                                    <option value="0"
                                                                        <?php if($category_info->contest_category_status == 0) 'selected: selected' ?>>
                                                                        Inactive
                                                                    </option>
                                                                </select>
                                                            </div>

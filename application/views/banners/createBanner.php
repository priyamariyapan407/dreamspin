                        ...
                        <div class="container-fluid">
                            <div class="row category_head">
                                ...
                                <div class="col-sm-6 col-lg-6 col-md-6 text_end category_head_right">
                                    <form method="post" action="<?php echo base_url('Banners/storeBanner') ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="banner_name"
                                                                    value="<?php if($this->session->flashdata('banner_name')) echo $this->session->flashdata('banner_name'); ?>"
                                                                    class="form-control"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="status_value" class="custom-select">
                                                                    ...
                                                                    <option value="1"
                                                                        <?php if($this->session->flashdata('status_value') == 1) echo 'selected=selected' ?>>
                                                                        Active
                                                                    </option>
                                                                    <option value="0"
                                                                        <?php if($this->session->flashdata('status_value') == 0) echo 'selected=selected' ?>>
                                                                        Inactive
                                                                    </option>
                                                                </select>
                                                            </div>

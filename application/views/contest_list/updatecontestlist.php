                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6" style="padding-left: 1%;padding-bottom: 1%;">
                            <h1>Add Contest List</h1>
                        </div>

                        <div class="col-sm-6 text-end" style="padding-right: 1%;">
                            <form method="post" action="<?php echo base_url('ContestList/updatecontentlist') ?>">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="card-body">
                                                    <?php if($this->session->flashdata('edit_contest_list_error')){ ?>
                                                    <div class='alert alert-danger' role="alert">
                                                        <?php echo $this->session->flashdata('edit_contest_list_error') ?>
                                                    </div>
                                                    <?php   } ?>
...
//  echo "<pre>"; print_r($content_list_info_by_id);

                                                                foreach($content_list_info_by_id as $content_list) ?>
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            ...
                                                                            <label class="col-form-label">
                                                                                Contest Name</label>
                                                                            <input type="text"
                                                                                value="<?php echo $content_list->$contest_name ?>"
                                                                                name="contest_name" class="form-control"
                                                                                placeholder="Please contest name">
                                                                            <input type="hidden"
                                                                                value="<?php echo $content_list->contest_id  ?>"
                                                                                name="contest_id" class="form-control"
                                                                                placeholder="Please contest name">
                                                                            <input type="hidden"
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            ...
                                                                            <select name="contest_status"
                                                                                ...
                                                                                <option value="1"
                                                                                    <?php if($content_list->$contest_status == 1) echo "selected='selected'" ?>>
                                                                                    Active
                                                                                </option>
                                                                                <option value="0"
                                                                                    <?php if($content_list->$contest_status == 0) echo "selected='selected'" ?>>
                                                                                    Inactive
                                                                                </option>
                                                                            </select>

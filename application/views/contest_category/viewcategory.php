                    ...
                    <div class="row mb-2">
                        <div class="row category_head">
                            <div class="col-sm-6 col-lg-6 col-md-6 category_head_left">
                                <h1>View Contest Category List</h1>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6 text_end category_head_right">
                                <form method="post"
                                    ...
                                    <a>
                                        <a
                                            href="<?php echo base_url('ContestCategory/updatecategory/'.$category_info_by_id[0]->contest_category_id) ?>">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="contest_category_id"
                                                                value="<?php $category_info->contest_category_id ?>">
                                                            <div class="form-group">

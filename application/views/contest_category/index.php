                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text_end" style="padding-right: 1%;">
                            <a href="<?php echo base_url('ContestCategory/createCategory') ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                    $count = 1;
                     foreach($contest_cat_info as $contest_cat) { 
                        ?>
                                            <tr>
                                                <td><?php echo $count ?></td>
                                                <td> <?php echo $contest_cat->contest_category_name; ?></td>
                                                <td> <?php echo $contest_cat->contest_category_status == 1 ? '<div class="row" style="height: 100%;">
                                                ...
                                                <td class="action_colmn">
                                                    <span class="fa_view" style="margin: 2%;">
                                                        <a style="color:#000 !important"
                                                            href="<?php echo base_url('ContestCategory/viewcategory/'.$contest_cat->contest_category_id) ?>"><span
                                                                class='fas fa-eye'></span></a></span>
                                                    <span class="fa_edit" style="margin: 2%;">
                                                        <a style="color:#000 !important"
                                                            href="<?php echo base_url('ContestCategory/updatecategory/'.$contest_cat->contest_category_id) ?>"><span
                                                    ...
                                                    <span class="fa_delete" style="margin: 2%;">
                                                        <span style="cursor:pointer;" data-bs-toggle="modal"
                                                            ...
                                                            onclick="deleteCatid('<?php echo $contest_cat->contest_category_id ?>')">

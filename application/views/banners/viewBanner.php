                            ...
                            <div class="row category_head">
                                ...
                                <div class="col-sm-6 col-lg-6 col-md-6 text_end category_head_right">
                                    <form method="post">
                                        ...
                                        <a href="<?php echo base_url('Banners/index') ?>">
                                            <span type="button" class="btn btn-default">
                                                Cancel
                                            </span></a>
                                        <a>
                                            <a
                                                href="<?php echo base_url('Banners/updateBanner/'.$banner_info[0]->banner_id) ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="card-body">
                                                        <?php if($this->session->flashdata('create_banner_error')){ ?>
                                                        <div class='alert alert-danger' role="alert">
                                                            <?php echo $this->session->flashdata('create_banner_error') ?>
                                                        </div>
                                                        <?php   } ?>
                                                        ...
                                                        <?php   } ?>
                                                        <?php if($this->session->flashdata('empty_banner_error')){ ?>
                                                        <div class='alert alert-danger' role="alert">
                                                            <?php echo $this->session->flashdata('empty_banner_error') ?>
                                                        </div>
                                                        <?php   } ?>
                                                        <?php foreach($banner_info as $banner){ ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="banner_name"
                                                                    value="<?php echo $banner->banner_name ?>"
                                                                    class="form-control disableclass"
                                                                    placeholder="Enter banner name" disabled>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-form-label">
                                                                    Banner Image</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Status</label>
                                                                <select name="status_value" disabled
                                                                    class="custom-select disableclass">
                                                                    <option value="">Please select status</option>
                                                                    <option value="1"
                                                                        <?php if($banner->status == 1) echo 'selected=selected'?>>
                                                                        Active
                                                                    </option>
                                                                    <option value="0"
                                                                        <?php if($banner->status == 0) echo 'selected=selected'?>>
                                                                        Inactive
                                                                    </option>
                                                                </select>
                                                            </div>
